...
<link rel="stylesheet" id="login-css" href="https://paolovillaverde.github.io/PaoloVillaverde/wp-admin/css/login.min.css?ver=5.7" media="all">
	...
	<script type="text/javascript">
		...
		<form name="loginform" id="loginform" action="https://paolovillaverde.github.io/PaoloVillaverde/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="https://paolovillaverde.github.io/PaoloVillaverde/wp-admin/">
									<input type="hidden" name="testcookie" value="1">
			</p>
		</form>

					<p id="nav">
								<a href="https://paolovillaverde.github.io/PaoloVillaverde/wp-login.php?action=lostpassword">Lost your password?</a>
			</p>
					<script type="text/javascript">
...
var _zxcvbnSettings = {"src":"https:\/\/paolovillaverde.github.io\/PaoloVillaverde\/wp-includes\/js\/zxcvbn.min.js"};
</script>
<script src="https://paolovillaverde.github.io/PaoloVillaverde/wp-includes/js/zxcvbn-async.min.js?ver=1.0" id="zxcvbn-async-js"></script>
<script src="https://paolovillaverde.github.io/PaoloVillaverde/wp-includes/js/dist/vendor/wp-polyfill.min.js?ver=7.4.4" id="wp-polyfill-js"></script>
<script id="wp-polyfill-js-after">
( 'fetch' in window ) || document.write( '<script src="https://paolovillaverde.github.io/PaoloVillaverde/wp-includes/js/dist/vendor/wp-polyfill-fetch.min.js?ver=3.0.0"><\/scr' + 'ipt>' );( document.contains ) || document.write( '<script src="https://paolovillaverde.github.io/PaoloVillaverde/wp-includes/js/dist/vendor/wp-polyfill-node-contains.min.js?ver=3.42.0"><\/scr' + 'ipt>' );( window.DOMRect ) || document.write( '<script src="https://paolovillaverde.github.io/PaoloVillaverde/wp-includes/js/dist/vendor/wp-polyfill-dom-rect.min.js?ver=3.42.0"><\/scr' + 'ipt>' );( window.URL && window.URL.prototype && window.URLSearchParams ) || document.write( '<script src="https://paolovillaverde.github.io/PaoloVillaverde/wp-includes/js/dist/vendor/wp-polyfill-url.min.js?ver=3.6.4"><\/scr' + 'ipt>' );( window.FormData && window.FormData.prototype.keys ) || document.write( '<script src="https://paolovillaverde.github.io/PaoloVillaverde/wp-includes/js/dist/vendor/wp-polyfill-formdata.min.js?ver=3.0.12"><\/scr' + 'ipt>' );( Element.prototype.matches && Element.prototype.closest ) || document.write( '<script src="https://paolovillaverde.github.io/PaoloVillaverde/wp-includes/js/dist/vendor/wp-polyfill-element-closest.min.js?ver=2.0.2"><\/scr' + 'ipt>' );( 'objectFit' in document.documentElement.style ) || document.write( '<script src="https://paolovillaverde.github.io/PaoloVillaverde/wp-includes/js/dist/vendor/wp-polyfill-object-fit.min.js?ver=2.3.4"><\/scr' + 'ipt>' );
</script>
